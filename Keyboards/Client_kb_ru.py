...
b22 = KeyboardButton('/ФОТО')
b23 = KeyboardButton('/ПОСМОТРЕТЬ')
b24 = KeyboardButton('/ЗАГРУЗИТЬ')
...
workout_kb_ru = ReplyKeyboardMarkup(resize_keyboard=True, one_time_keyboard=True).add(b9, b10, b11).add(b17).add(b22)
...
photo_ru = ReplyKeyboardMarkup(resize_keyboard=True, one_time_keyboard=True).add(b23, b24)
